...
test('real package counts and current/historical activity windows match an independent calculation', () => {
...
test('real historical line points and their popups stay frozen as more activity arrives', () => {
  const agg = new Aggregator(dataset.companies)
...
test('batch sizes do not alter results; historical inspection matches a stopped replay', () => {
